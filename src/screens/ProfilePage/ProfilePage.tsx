import { Card, Typography, Col, Row, Button, AutoComplete } from 'antd';
    ...
    <div style={{  background: 'white', display: 'flex', justifyContent: 'center'}}>
      <Row>
        <Col span={8}>
          ...
          >
            <img alt="example" src={avatar} style={{ width: 100, height: 100, borderRadius: 90 }} />
            <Title level={4}>Владимир. Б</Title>

            <Text type="secondary">Г. Бишкек</Text>
            <Text style={{display: 'block' ,marginTop: 20}}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry is standard dummy text ever since the 1500s.</Text>
            
            <Row gutter={[16, 16]} style={{marginTop: 30}}>
              <Col span={24}>
                <Link href="#" type="success" underline style={{ color: '#80DBA6', fontWeight: 500 }}>Мои объявления</Link>
              </Col>
              <Col span={24}>
              ...
              <Row>
                ...
                <Col span={19}>
                  ...
                  <div style={{width: 600, display: 'flex', justifyContent: 'space-between', marginBottom: -13, marginTop: -3}}>
                    <Title level={4} style={{color: '#80DBA6'}}>Хороший добрый пес</Title>
